 ...
 */
/* let array3 = [4, 67, 12, 44, 60, 50, 31,29];
let dispari = [];

for (let i = 0 ; i <= array3.lengt; i++) {
  if (array3[i] % 2 === 0){
 ...
 */
/* let array = [2, 4, 6, 8, 3, 1, 9, 0, 10, 5]; */
...
/* let array = ["angelo", "belardo", "ragazzo", "epicoders"];
...
for (let i = 0; i < movies.length; i++) {
  if (parseInt(movies[i].Year > parseInt(elderMovie.Year)))
  elderMovie = movies [i]
}
...
for (let i = 0; i < movies.length; i++) {
  if (movies[i].Title.includes(keyW)) {
    console.log(movies[i]);
  }
} */
